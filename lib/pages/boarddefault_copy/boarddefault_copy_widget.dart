...
import 'boarddefault_copy_model.dart';
export 'boarddefault_copy_model.dart';

class BoarddefaultCopyWidget extends StatefulWidget {
  const BoarddefaultCopyWidget({Key? key}) : super(key: key);

  @override
  _BoarddefaultCopyWidgetState createState() => _BoarddefaultCopyWidgetState();
}

class _BoarddefaultCopyWidgetState extends State<BoarddefaultCopyWidget> {
  late BoarddefaultCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoarddefaultCopyModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().update(() {
        FFAppState().postType = '1';
        FFAppState().postType2 = '0';
        FFAppState().rank = '전체';
        FFAppState().rank2 = '전체';
      });
    });
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        style: FlutterFlowTheme.of(context)
                                                                            ...
                                                                            .override(
                                                                              fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                              color: FFAppState().postType2 == '0' ? FlutterFlowTheme.of(context).alltxt : Color(0x8C1A1A1A),
                                                                              fontSize: 16.0,
                                                                              fontWeight: FontWeight.bold,
                                                                              useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).bodyMediumFamily),
                                                                            ),
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: StreamBuilder<
                                                                ...
                                                                stream:
                                                                    queryRankRecord(
                                                                  queryBuilder: (rankRecord) => rankRecord
                                                                      .where(
                                                                          'User',
                                                                          isEqualTo:
                                                                              currentUserReference)
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: List.generate(
                                                                          columnRankRecordList
                                                                              .length,
                                                                          (columnIndex) {
                                                                        final columnRankRecord =
                                                                            columnRankRecordList[columnIndex];
                                                                        return Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(
                                                                              0.0,
                                                                              0.0,
