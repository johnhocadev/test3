  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: FlutterFlowTheme.of(context).subcolor,
                        ...
                        onPressed: () async {
                          ...
                          await contestRecordReference.set({
                            ...createContestRecordData(
                              contestType: '게임',
                              title: _model.gamenameController.text,
                              totalroundnumber: valueOrDefault<int>(
                              ...
                              rules2: _model.textController3.text,
                            ),
                            'players': [
                            ...
                            builder: (context) {
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: SuccessWidget(
                                    title: '게임 생성 완료',
                                    contents: '게임방이 생성되었습니다. 즐거운 게임 되시기 바랍니다.',
                                    button: '확인',
                                  ),
                                ),
                              );
